...
public class ParserTest {
    ...
    public void parseRule()
    {
        ...
        Rule expected = new RuleImpl(new ComplexTerm("foo",new Variable("x"),new Variable("y")), new RuleAnd(new ComplexTerm("bar",new Variable("x"),new Variable("z")), new ComplexTerm("foo",new Variable("z"),new Variable("y"))));
